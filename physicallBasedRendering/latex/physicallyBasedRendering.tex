...
Der \textbf{Raumwinkel} ($\omega$) funktioniert analog zum Bogenmaß im 3-dimensionalen Raum. Er ist definiert als das Verhältnis der Kugelfläche $A$ zum quadratischen Radius der Kugel $r^{2}$, d.h. $\omega =\tfrac{A}{r^{2}}$. Die Fläche, welche im Bild
...
Die \textbf{Bestrahlungsstärke} ($E$) ist ein Maß für die Stärke der Lichteinstrahlung auf einer Oberfläche. Sie ist definiert als $E=\tfrac{\Delta \phi}{\Delta A}$. Hierbei ist $E$ die Relation zwischen der Strahlungsfluss $\Delta \phi$, die auf eine gegebene Fläche mit dem Flächeninhalt $\Delta A$ einfällt 
...
Um die Gesamtmenge des auf die Fläche fallenden Lichts zu errechnen, wird die Summe der Strahldichten aller Lichtquelle gemessen. Physikalisch korrekt wird hierzu die Summe als Integral über die Hemisphäre $\Omega$ gebildet. 

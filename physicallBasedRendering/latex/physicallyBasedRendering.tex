...
Damit eine BRDF auch ein physikalisches Modell darstellt müssen folgende zusätz\-liche physikalische Gesetze gelten 
...
Des Weiteren ist es möglich bei der Berechnung der Fresnel-Gleichung noch zusätz\-liche Annährung zu machen. Für die dielektrischen Oberflächen wird beispielweise ein fester Basisreflexionsgrad gesetzt (F0 = 0,04), welcher dennoch zu physikalisch plausiblen Ergebnissen führt (vgl. \cite{learnOpenGL}).
